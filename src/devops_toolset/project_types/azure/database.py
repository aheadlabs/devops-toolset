...
def add_mysql_flexible_server_firewall_rule(
        ...
        rule_name: str,
        ip_address: str,
        end_ip_address: [str, None] = None) -> dict:
...
def execute_mysql_flexible_server_sql_script(admin_user: str, admin_password: str,
                                             server_name: str, database_name: str,
                                             file_path: [str, None] = None, query: [str, None] = None) -> [str, None]:
...
def remove_mysql_flexible_server_firewall_rule(
        server_name: str,
        resource_group: str,
        rule_name: str) -> str:
