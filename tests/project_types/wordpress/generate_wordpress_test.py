""" Unit core for the generate wordpress script """
...
import devops_toolset.project_types.wordpress.generate_wordpress as sut
...
@patch("devops_toolset.project_types.wordpress.generate_wordpress.setup_devops_toolset")
...
def test_main_given_required_files_when_create_development_theme_then_calls_create_development_theme(
    ...
    # Assert
    create_dev_theme_mock.assert_called_once_with(ANY, root_path, constants)
